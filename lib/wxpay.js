...
WXPay.mix('siteRequestParams', function(prepayId){
    var params = {
...
WXPay.mix('appRequestParams', function(prepayId){
    var params = {
        appid:      this.options.appid,
...
WXPay.mix('transfer',function(order, fn){
...
WXPay.mix('queryTransferInfo',function(order, fn){
